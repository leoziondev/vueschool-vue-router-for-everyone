...
const routes = [
    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunckName: "ExperienceDetails" */ "../views/ExperienceDetails"
          ),
      },
    ],
  ...
  },
  {
    path: "/user",
    name: "user",
    component: () => import(/* webpackChunckName: "User" */ "../views/User"),
  ...
  },
  {
    ...
    name: "invoices",
    component: () =>
      import(/* webpackChunckName: "Invoices" */ "../views/Invoices"),
    meta: { requiresAuth: true },
  },
  {
    path: "/login",
